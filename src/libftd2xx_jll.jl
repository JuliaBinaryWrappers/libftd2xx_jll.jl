...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import libftd2xx_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("66e46913-a265-5186-af4c-28555ad2a364"))
platforms = [Pkg.Artifacts.unpack_platform(e, "libftd2xx", artifacts_toml) for e in artifacts["libftd2xx"]]
...
if best_platform === nothing
    @debug("Unable to load libftd2xx; unsupported platform $(triplet(platform_key_abi()))")
else
